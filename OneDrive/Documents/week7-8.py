...
while True:
    ...
    record = input("Do you want to add another record ? If YES enter y If NO enter n - y/n :  ") #asking user to add another record using y/n
    if record == "n":  #if user enters n then it will not ask to add another record, if user enters y then it will ask to add another record
        break
